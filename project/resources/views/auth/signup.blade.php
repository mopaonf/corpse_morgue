...
<div class="w-full mt-36 max-w-md mx-auto">
    <div class="bg-white dark:bg-gray-800 shadow-xl rounded-lg px-6 py-6 backdrop-blur-sm dark:bg-gray-800/50">
        <div class="text-center mb-6">
            ...
            <p class="text-sm text-gray-600 dark:text-gray-400 mt-2">Join us today</p>
        </div>
        ...
        <form action="{{ route('register') }}" method="POST" class="space-y-4">
            ...
            <div class="space-y-4">
                <div>
                    ...
                    <input type="text" name="name" class="w-full px-4 py-2 text-sm border rounded-lg" required autofocus />
                </div>

                <div>
                    <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Email Address</label>
                    <input type="email" name="email" class="w-full px-4 py-2 text-sm border rounded-lg" required />
                </div>
                ...
                <div>
                    ...
                    <input type="password" name="password_confirmation" class="w-full px-4 py-2 text-sm border rounded-lg" required />
                </div>
        ...
        <div class="mt-6 text-center">
            <p class="text-sm text-gray-600 dark:text-gray-400">
                ...
                <a href="{{ route('login') }}" class="text-[#463020] hover:text-[#75533a] font-medium">Sign In</a>
            </p>
        </div>
    </div>
</div>
